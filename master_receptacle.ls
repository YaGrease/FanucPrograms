...
COMMENT		= "";
PROG_SIZE	= 2381;
CREATE		= DATE 26-08-17  TIME 14:41:32;
MODIFIED	= DATE 26-08-17  TIME 14:41:32;
FILE_NAME	= MASTER_R;
VERSION		= 0;
LINE_COUNT	= 85;
MEMORY_SIZE	= 2809;
...
/MN
   ...
   5:  UTOOL_NUM=1 ;
   6:   ;
   7:J P[5:STATIC_HOME] 100% CNT100 ACC60    ;
   8:   ;
   9:  ! Init data registers ;
  10:  R[1:REPO_RCP_X]=1    ;
  11:  R[2:REPO_RCP_Y]=1    ;
  ...
  35:  R[27:CAMERA_MODE]=0    ;
  36:  R[28]=0    ;
  37:   ;
  38:  ! Position Registers ;
  39:  ! Init calibration location ;
  40:  PR[1:TMP_DATUM]=P[1:STATIC_DATUM]    ;
  41:   ;
  42:  ! Init camera location ;
  43:  PR[3:TMP_CAMERA]=P[3:STATIC_CAMERA]    ;
  44:   ;
  45:  ! Init repository locations ;
  ...
  57:   ;
  58:  ! Init error locations ;
  59:  PR[12:RELEASE_ONE]=P[6:STATIC_RLS_ONE]    ;
  60:  PR[13:RELEASE_TWO]=P[7:STATIC_RLS_TWO]    ;
  61:   ;
  62:  ! Pause for recipe input ;
  63:  MESSAGE[ENTER RECIPE IN R[10]] ;
  64:  ! After completion resume ;
  65:  PAUSE ;
  66:   ;
  67:  ! Init data for recipe retrieval ;
  68:  R[99:RECIPE_IDX]=101    ;
  69:  R[98:RECIPE_LOWER_LIM]=0    ;
  70:  R[97:RECIPE_UPPER_LIM]=37    ;
  71:  R[96:RECIPE_LOCATION]=R[10:RECIPE_NUMBER   ]*37    ;
  72:  R[95:RECIPE_BASE]=100    ;
  73:  R[96:RECIPE_LOCATION]=R[95:RECIPE_BASE]+R[96:RECIPE_LOCATION]+3    ;
  74:   ;
  75:  ! Init recipe retrieved for use ;
  76:  LBL[1] ;
  77:  IF R[98:RECIPE_LOWER_LIM]>=R[97:RECIPE_UPPER_LIM],JMP LBL[2] ;
  78:  R[R[95]]=R[R[96]]    ;
  79:  R[96:RECIPE_LOCATION]=R[96:RECIPE_LOCATION]+1    ;
  80:  R[95:RECIPE_BASE]=R[95:RECIPE_BASE]+1    ;
  81:  R[98:RECIPE_LOWER_LIM]=R[98:RECIPE_LOWER_LIM]+1    ;
  82:  JMP LBL[1] ;
  83:   ;
  84:  LBL[2] ;
  85:  CALL PICK_AND_PLACE    ;
/POS
P[1:"STATIC_DATUM"]{
   GP1:
