...
COMMENT		= "";
PROG_SIZE	= 1983;
CREATE		= DATE 26-07-10  TIME 11:39:24;
MODIFIED	= DATE 26-07-10  TIME 11:39:24;
FILE_NAME	= MASTER_R;
VERSION		= 0;
LINE_COUNT	= 73;
MEMORY_SIZE	= 2459;
...
/MN
  ...
  26:  R[17:ICE_TRAY_YOFFSET]=108.236    ;
  27:  R[19:REPO_XOFFSET]=374.967    ;
  28:  R[20:REPO_YOFFSET]=108.236    ;
  29:  R[21:PICKUP_CONSTANT]=20.1    ;
  ...
  36:   ;
  37:  ! Camera location load ;
  38:  PR[3:TMP_CAMERA]=P[3:STATIC_CAMERA]    ;
  39:   ;
  40:  ! Repository location load ;
  ...
  58:  R[99:RECIPE_IDX]=101    ;
  59:  R[98:RECIPE_LOWER_LIM]=0    ;
  60:  R[97:RECIPE_UPPER_LIM]=37    ;
  61:  R[96:RECIPE_LOCATION]=R[10:RECIPE_NUMBER]*37    ;
  62:  R[95:RECIPE_BASE]=100    ;
  63:  R[96:RECIPE_LOCATION]=R[95:RECIPE_BASE]+R[96:RECIPE_LOCATION]+3    ;
  64:  LBL[1] ;
  65:  IF R[98:RECIPE_LOWER_LIM]>=R[97:RECIPE_UPPER_LIM],JMP LBL[2] ;
  66:  R[R[95]]=R[R[96]]    ;
  67:  R[96:RECIPE_LOCATION]=R[96:RECIPE_LOCATION]+1    ;
  68:  R[95:RECIPE_BASE]=R[95:RECIPE_BASE]+1    ;
  69:  R[98:RECIPE_LOWER_LIM]=R[98:RECIPE_LOWER_LIM]+1    ;
  70:  JMP LBL[1] ;
  71:   ;
  72:  LBL[2] ;
  73:  CALL PICK_AND_PLACE    ;
/POS
P[1:"STATIC_DATUM"]{
   GP1:
